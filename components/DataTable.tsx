  ...
  return (
    <div className="overflow-x-auto relative shadow-sm rounded-sm">
      <table className="w-full border-collapse min-w-[1800px] text-sm">
        <thead>
          <tr className="bg-[#f5f7fa] text-gray-800 font-bold border-b border-[#ebeef5]">
            <th className="py-3 px-3 text-center w-14">序号</th>
            <th className="py-3 px-3 text-left">是否垫付</th>
            <th className="py-3 px-3 text-left">师傅</th>
            <th className="py-3 px-3 text-left">师傅uid</th>
            <th className="py-3 px-3 text-left">派单员</th>
            <th className="py-3 px-3 text-left">来源</th>
            <th className="py-3 px-3 text-left">订单号</th>
            <th className="py-3 px-3 text-center">查看券码</th>
            <th className="py-3 px-3 text-center">状态</th>
            <th className="py-3 px-3 text-left">总收款</th>
            <th className="py-3 px-3 text-left">成本</th>
            <th className="py-3 px-3 text-left">业绩</th>
            <th className="py-3 px-3 text-left">完工收入</th>
            <th className="py-3 px-3 text-left w-40">申请时间</th>
            <th className="py-3 px-3 text-left">审核时间</th>
            <th className="py-3 px-3 text-left">审核人</th>
            <th className="py-3 px-3 text-left">审核意见</th>
            <th className="py-3 px-3 text-left">补款金额</th>
            <th className="py-3 px-3 text-left">补款状态</th>
            <th className="py-3 px-3 text-center w-32 sticky right-0 bg-[#f5f7fa] z-10 shadow-[-5px_0_10px_-5px_rgba(0,0,0,0.1)]">操作</th>
          </tr>
        </thead>
